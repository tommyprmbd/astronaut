            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        ...
                        <form action="{{ route('role.update', $role->id) }}" method="post" class="mt-4 text-gray-700 space-y-6">
                            @csrf
                            ...
                            <div>
                                ...
                                @else
                                    @foreach ($permissions as $name)
                                        ...
                                        @if (!empty(old('permission')) && in_array($name, old('permission')) || $role->hasPermissionTo($name))
                            ...
                            <x-cancel-button :route="route('role.index')">{{ __('Cancel') }}</x-cancel-button>
                        </form>
                    </section>
                </div>
            </div>
